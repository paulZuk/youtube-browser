...
module.exports = function xhrAdapter(resolve, reject, config) {
  ...
  if (utils.isStandardBrowserEnv()) {
    ...
    var urlIsSameOrigin = __webpack_require__(39);
...
var _youtubeSearchApiWithAxios = __webpack_require__(31);

var _youtubeSearchApiWithAxios2 = _interopRequireDefault(_youtubeSearchApiWithAxios);

var _SearchBar = __webpack_require__(42);

var _SearchBar2 = _interopRequireDefault(_SearchBar);

var _VideoList = __webpack_require__(43);
...
var API_KEY = 'AIzaSyCIH-ndr0B_cqK0qDpjdBja_3WGJ_wQCXM';
...
var App = function (_Component) {
    ...
    _createClass(App, [{
        ...
        value: function search(term) {
            ...
            (0, _youtubeSearchApiWithAxios2.default)({ key: API_KEY, q: term, maxResults: 5 }, function (data) {
                _this2.setState({
                    data: data
                });
            });
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_SearchBar2.default, { updateSearchTerm: function updateSearchTerm(search) {
                            return _this4.updateSearchTerm(search);
                        } })
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'row' },
                    _react2.default.createElement(_VideoPlayer2.default, { link: this.state.link }),
                    _react2.default.createElement(_VideoList2.default, {
                        onClickItem: function onClickItem(link) {
                            return _this4.loadVideo(link);
                        },
                        data: data })
                )
            );
...
var _VideoItem = __webpack_require__(44);
            ...
            return _react2.default.createElement(
                'li',
                {
                    ...
                    onClick: function onClick(link) {
                        return _this2.handleClick(videoId);
                    },
...
var VideoPlayer = function (_Component) {
    ...
    _createClass(VideoPlayer, [{
        key: 'render',
        value: function render() {
            var link = 'https://www.youtube.com/embed/' + (this.props.link !== "" ? this.props.link + '?autoplay=1' : 'dQw4w9WgXcQ?autoplay=0');
            return _react2.default.createElement(
                'div',
                { className: 'col-sm-8' },
